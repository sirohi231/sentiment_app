...
html_form = """
    <h2>Paste a tweet here:</h2>
    
    <form action="/predict" method="post" enctype="text/html">
    <textarea name="tweet" style="width:250px;height:150px;"></textarea>
    </br>
